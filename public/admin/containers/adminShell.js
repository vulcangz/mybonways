...
var AdminShell = {
  ...
  view:function(vnode){
	return (
	  <section>
  		<section class="  pt3-ns   ph5-ns black-80 " style="background-color:#95a5a6">
      ...
      <footer class="pa3 bg-light-gray tc mt4">
        ...
        <small style="font-size:0.5rem">
          Built By <a href="http://past3.com.ng" target="_blank">Past3 Software Studios</a> All rights reserved.
        </small>
      </footer>
	  </section>
	)
