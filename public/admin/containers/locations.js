...
var Locations = {
	VerifyNewLocation: () => {
		if (
			!LocationModel.NewLocation.country ||
			!LocationModel.NewLocation.city ||
			!LocationModel.NewLocation.neighbourhood
		) {
		...
		LocationModel.AddLocation()
			...
			.catch(error => {
				...
				Locations.state.NewLocationMessage = "";
				Locations.state.NewLocationError =
					"Could not add this location. Maybe it already exists.";
				Locations.state.Loader = false;
			});
	},
	state: {
		...
		return (
			<section>
				...
				<div class="pa3 bg-white shadow-m2 mt3 cf">
					{Locations.state.NewLocationError
						? m(
								"p.pa1.bg-red-custom.mv0.white.w5.br1.tc",
								Locations.state.NewLocationError
							)
						: ""}
					{Locations.state.NewLocationMessage
						? m(
								"p.pa1.bg-navy.mv0.white.w5.br1.tc",
								Locations.state.NewLocationMessage
							)
						: ""}
					<div class="">
						<input
							type="text"
							placeholder="Country"
							class="pa2 ba b--gray w5 bw1 mv1"
							oninput={m.withAttr("value", function(value) {
								LocationModel.NewLocation.country = value;
							})}
							value={LocationModel.NewLocation.country}
						/>
						<br />
						<input
							class="pa2 ba b--gray w5 bw1 mv1"
							...
							value={LocationModel.NewLocation.city}
						/>
						<br />
						<input
							class="pa2 ba b--gray w5 bw1 mv1"
							...
							value={LocationModel.NewLocation.neighbourhood}
						/>
						<br />
						<button
							type="button"
							class="ba b--navy bg-navy pv2 ph4 white shadow-3 pointer mv1"
							onclick={() => {
								console.log("Add Location clicked");
								Locations.VerifyNewLocation();
							}}
						>
							{Locations.state.Loader ? m(".loader.mv0") : "Add Location"}
						</button>
					</div>
				</div>
					...
					<div class="bb b--light-gray pv2">
						<div class="w-third-ns pa1 dib-ns">
							...
							>
								...
								{LocationModel.AllCountries.length
									? LocationModel.AllCountries.map((location, i) => {
											return (
						...
						<div class="w-third-ns pa1 dib-ns">
							...
							>
								...
								{LocationModel.AllCities.length
									? LocationModel.AllCities.map((location, i) => {
											return (
						...
						<div class="w-third-ns pa1 dib-ns">
							<select
								...
								onchange={e => {
									...
									document.getElementById("new_neighbourhood").value =
										e.target.value;
								}}
							>
								<option disabled selected>
								...
								{LocationModel.AllNeighbourhoods.length
									? LocationModel.AllNeighbourhoods.map((location, i) => {
											return (
												<option value={location.neighbourhood}>
					...
					<div class="">
						<div class="w-third-ns pa1 dib-ns">
							<input
								type="text"
								id="new_country"
								class="pa2 ba b--light-silver w-100"
								placeholder=""
								oninput={m.withAttr("value", value => {
									LocationModel.NewLocationUpdate.country = value;
									console.log(
										"country: ",
										LocationModel.NewLocationUpdate.country
									);
								})}
							/>
							<div class="tc pv2">
								<button
									class="bg-navy white ba b--transparent br1 shadow-4 pa2 pointer"
									onclick={() => {
						...
						<div class="w-third-ns pa1 dib-ns">
							<input
								...
								oninput={m.withAttr("value", value => {
									...
									console.log(
										"neighbourhood: ",
										LocationModel.NewLocationUpdate.neighbourhood
									);
								})}
							/>
							<div class="tc pv2">
