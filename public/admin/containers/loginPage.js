...
var LoginPage = {
	...
	ValidateLogin: () => {
		...
		AdminModel.Login(LoginPage.LoginAdmin)
			.then(() => {
							...
							<div class="v-mid dib fr">
								<div class="dib relative">
									...
									>
										{LoginPage.state.LoginError
											? m(
													"p.bg-red-custom.white.tc.mv0.pa1",
													LoginPage.state.LoginError
												)
											: ""}
										<div class="db pv1">
										...
										<div class="db tr">
											<button
												class="pv2 ph3 bg-navy bw0 shadow grow white-80 pointer w4"
												onclick={function() {
													{
											...
											>
												{LoginPage.state.loader ? m(".loader") : "Login"}
											</button>
										</div>
									</div>
								</div>
