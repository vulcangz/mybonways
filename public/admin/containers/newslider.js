		...
		return (
			<section>
				...
				<div class="pa3 bg-white shadow-m2 mt3 cf">
					{NewSlider.Error
						? <p class="bg-red-custom white mv0 pa2 tc">
								{NewSlider.Error}
							</p>
						: ""}
					<div class="">
					...
					<div class="pa2">
						...
						<div class=" w-100 ">
							...
							<input
								...
								class="dn"
								onchange={m.withAttr("files", NewSlider.ImageChange)}
							/>
					...
					<div class="tr">
						<button
							class="bg-navy white grow pa2 w3 ba b--transparent mh2 pointer"
							onclick={() => {
								NewSlider.SaveSlide();
							}}
						>
							{NewSlider.loader ? m(".loader") : "ADD"}
						</button>
					</div>
				</div>
			</section>
