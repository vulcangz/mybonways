...
export var ListingItem = {
	...
	view: function(vnode) {
		...
		console.log(listing);
		return (
			<div class=" dib w-100 w-50-ns  pa1 " key={key}>
				<div class=" bg-white shadow-m2 pa2">
					...
					<div class="tr">
						<button
							class="dib pv2 ph3 shadow-4  bw0 ma2 grow link black bg-light-silver pointer"
							onclick={() => ListingItem.DeleteListing(listing.Slug)}
						>
							Delete
						</button>
						<button
							class="dib pv2 ph3 shadow-4  bw0 ma2 grow link black bg-light-silver pointer"
							onclick={() => ListingItem.ApproveListing(listing.Slug)}
						>
							Approve
						</button>
						<a
							class="dib pv2 ph3 shadow-4  bw0 ma2 grow link black bg-light-silver"
