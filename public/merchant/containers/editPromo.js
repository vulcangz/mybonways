	...
	oncreate: vnode => {
		...
		Promos.GetPromo(vnode.attrs.slug).then(() => {
			...
			EditPromo.state.startDate = new Flatpickr(datePickerBeginInput, {
				enableTime: true,
				defaultDate: [
					format(Promos.CurrentPromo.start_date, "YYYY-MM-DD h:mm a")
				],
			...
			EditPromo.state.endDate = new Flatpickr(datePickerEndInput, {
				enableTime: true,
				defaultDate: [
					format(Promos.CurrentPromo.end_date, "YYYY-MM-DD h:mm a")
				],
				plugins: [new confirmDatePlugin({})]
			});
			document.getElementById("beginDate").value = format(
				Promos.CurrentPromo.start_date,
				"YYYY-MM-DD h:mm a"
			);
			document.getElementById("endDate").value = format(
				Promos.CurrentPromo.end_date,
				"YYYY-MM-DD h:mm a"
			);
		});
	},
				...
				{Promos.CurrentPromo
					? <div class="pa3 pa4-ns bg-white shadow-m2 mt3 cf">
							...
							<div class="w-100 tc mv3">
								<label
									for="feature_image"
									class="mv3 ba b--navy white pointer bg-navy pv2 ph3 w-100"
								>
									Add A feature Image
									<input
										type="file"
							...
							<div class="">
								<p class="pa2 bt b--gray cf">
									...
									<input
										...
										value={Promos.CurrentPromo.item_name}
								...
								<p class="pa2 bt b--gray cf">
									...
									<input
										type="text"
										class="pa2 ba b--gray ml2 fr"
										value={Promos.CurrentPromo.new_price}
										oninput={m.withAttr("value", function(val) {
											EditPromo.state.updatebutton = false;
								...
								<p class="pa2 bt b--gray cf">
									...
									<input
										type="text"
										class="pa2 ba b--gray ml2 fr"
										value={Promos.CurrentPromo.old_price}
										oninput={m.withAttr("value", function(val) {
											EditPromo.state.updatebutton = false;
								...
								<p class="pa2 bt b--gray cf">
									...
									<input
										type="text"
										class="pa2 ba b--gray ml2 fr"
										value={Promos.CurrentPromo.description}
										oninput={m.withAttr("value", function(val) {
											EditPromo.state.updatebutton = false;
							...
							<button
								class={
									EditPromo.state.updatebutton
										? "dn"
										: " ba b--navy white pointer bg-navy pv2 ph3 w-100"
								}
								onclick={function() {
									Promos.CurrentPromo.start_date =
										EditPromo.state.startDate.selectedDates[0];
									Promos.CurrentPromo.end_date =
										EditPromo.state.endDate.selectedDates[0];
									console.log("Current Promo: ", Promos.CurrentPromo);
							...
							>
								{EditPromo.state.loader ? <div class="loader" /> : "UPDATE"}
							</button>
						</div>
					: ""}
			</section>
