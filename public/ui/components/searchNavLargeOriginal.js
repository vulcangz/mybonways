	...
	view: vnode => {
		return (
			<section>
				...
				<div class="pa2">
					<button class="bg-transparent b--transparent ma0 pa0">
						<div class=" cf flex justify-between relative">
							<div class="dib   flex relative " style="flex:7">
								<span
									class="dib searchbtn z-3 pv1 "
									style="padding-top:0.60rem"
								>
									<img
								...
								<input
									type="search"
									class={
										(searchNav.searchError ? " b--red " : " b--transparent ") +
										" w-100 pa1 ba input-reset searchinput bg-light-gray-custom"
									}
									placeholder="search"
							...
							<div class="dib ml2 flex relative" style="flex:3">
								...
								<input
									type="search"
									class="w-100 pa1 input-reset searchinput bg-light-gray-custom bw2 b--transparent"
									placeholder="area"
									id="areaInput"
									oninput={m.withAttr("value", function(value) {
