...
var SignupPage = {
	...
	validateLogin: function() {
		...
		UserModel.Login(SignupPage.LoginUser)
			.then(function() {
				// clear the forms
				// house keeping...
	...
	view: function(vnode) {
		return (
			<section>
				<section>
					<nav
						class="db pa2 shadow-4 fixed w-100 bg-white"
					>
						<div>
							<div class="dib">
					...
					<section
						style="background-image:url(/assets/img/user_login_bg.jpg)"
						class="vh-100 cover"
					>
						<section class="w-100 h-100  flex flex-column justify-center items-center">
							<section>
								<section class=" pa3 pa2-ns  br2 dib w-100 w-60-ns white-90 ">
									<div>
										<h2 class="f2 fw3 pl5-ns pr4-ns">
											Sign up to track and reserve all promos as they happen.
										</h2>
									</div>
								</section>
								<section class=" pa3 pa4-ns bg-white br2 dib w-100 w-40-ns shadow-3">
									<div class="">
										{SignupPage.state.signupError
											? m(
													"p.bg-red-custom.white.pv1.w-100.mv0.tc.br2",
